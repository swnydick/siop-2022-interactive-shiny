...
server <- function(input, output) {
  ...
  # REACTIVE OUTPUTS # 
  # Adding a trendline - and introducing a new button element - checkbox 
  ...
  # functions later. 
  # TODO Fix function so it doesn't always subset 
  ...
  output$data_at_clickpoint <- renderTable({
    ...
    # req is a necessary function - similiar to 'if we've clicked a new point'
    req(input$plot_click)
    
    # nearPoints is the function that finds the data 
  ...
  output$actual_productivity_statement <- renderText({
    ...
    # Part of the renderText function # 
    return(
